...
import CourseProgress from "../models/CourseProgress.js"; // Added import for CourseProgress
...
export const updateUserCourseProgress = async (req, res) => {
  try {
    ...
    console.log(userId, courseId, lectureId);
...
export const getUserCourseProgress = async (req, res) => {
  try {
    const userId = req.auth.userId;
    const { courseId } = req.body; // Fixed destructuring for courseId
    const progressData = await CourseProgress.findOne({ userId, courseId }); // Fixed typo: findone -> findOne
