...
const CourseDetails = () => {
  ...
  const { allCourses, calculateRating, calculateNoOfLecture, calculateCourseDuration, calculateChapterTime, currency } = useContext(AppContext);
        ...
        <div className="absolute top-0 left-0 w-full h-section-height bg-gradient-to-b from-cyan-100/70 pl-20 pt-30">
          <div className="flex flex-col md:flex-row gap-10">
            ...
            <div className="flex-1 max-w-xl z-10 text-gray-500">
              ...
              <p className="pt-4 md:text-base text-xs" dangerouslySetInnerHTML={{ __html: courseData.courseDescription.slice(0, 200) }}></p>
              ...
              <p className="text-sm">
                Course by <span className="text-blue-600 underline">Skillfy</span>
              </p>
                            ...
                            <li key={i} className="flex items-start gap-2 py-1">
                              ...
                              <div className="flex items-center justify-between w-full text-gray-800 text-xs md:text-default">
                                ...
                                <div className="flex gap-2">
                                  {lecture.isPreviewFree && <p onClick={() => setPlayerData({ videoId: extractVideoId(lecture.lectureUrl) })} className="text-blue-500 cursor-pointer">Preview</p>}
              ...
              <div className="py-5 text-sm md:text-default">
                <h3 className="text-sm font-semibold text-gray-800">Course Description</h3>
                <p className="pt-2 text-xs" dangerouslySetInnerHTML={{ __html: courseData.courseDescription }}></p>
              </div>
            </div>
            {/* Right column */}
