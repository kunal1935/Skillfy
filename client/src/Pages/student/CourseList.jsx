...
import Footer from '../../Components/student/Footer' // Corrected import path for Footer
...
const CourseList = () => {
  ...
  <div className='relative md:px-36 px-8 pt-20 text-left'>
    ...
    w-full'>
    <div>
      <h3 className='text-4xl font-semibold text-gray-800'>Course List</h3>
     ...
     <SearchBar onClick={console.log(filterCourse)}  data={input}/>
    </div>
