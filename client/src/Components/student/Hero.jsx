...
export const Hero = () => {
  return (
    ...
    >
      <h1 className="md:text-home-heading-large text-home-heading-small relative font-bold text-gray-800 max-w-3xl mx-auto px-4 md:px-0">
      ...
      <p className="md:block hidden text-gray-500 max-w-2xl mx-auto">
        ...
        variety of topics to help you hone your skills and become a successful
        professional.
      </p>
